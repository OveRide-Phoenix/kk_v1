                ...
                <li key={item.name}>
                  <Button
                    ...
                    className={`w-full justify-start ${
                      activePage === item.name ? "bg-secondary text-secondary-foreground" : ""
                    }`}
                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <Button
                      ...
                      onClick={() => handleNavigation("Product Management", "/admin/products")}
                    >
                    ...
                    <Button
                      variant="outline"
                      className="h-auto flex flex-col items-center justify-center p-4 space-y-2"
                      onClick={() => handleNavigation("Customer Management", "/admin/customers")}
                    >
                    ...
                    <Button
                      variant="outline"
                      className="h-auto flex flex-col items-center justify-center p-4 space-y-2"
                      onClick={() => handleNavigation("Daily Menu Setup", "/admin/menu")}
                    >
                    ...
                    <Button
                      variant="outline"
                      className="h-auto flex flex-col items-center justify-center p-4 space-y-2"
                      onClick={() => handleNavigation("Reports & Analytics", "/admin/reports")}
                    >
