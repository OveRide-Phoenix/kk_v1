...
function DBSchemaContent() {
  ...
  const loadSchema = useCallback(async () => {
    ...
    try {
      const response = await http.get(`/api/dev/db-schema?includeViews=true`);
          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                disabled={!hasDeveloperAccess || filteredTables.length === 0}
              >
                Copy All
              </Button>
            </div>
                      ...
                      <div className="space-y-4">
                        ...
                        {sqlEnabled && (
                          <div className="max-h-80 overflow-auto rounded-md border border-border bg-background/80 p-4">
                            <pre className="whitespace-pre text-xs font-mono text-foreground">
                              {table.ddl}
                            </pre>
                          </div>
                        )}
