...
/**
 * Hero section with parallax scrolling effects and animated content
 */
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-slide-up">
            ...
            >
              Healthy, Hygienic & Delicious – Subscribe or Order Now
            </p>
            <div
          ...
          <div className="grid grid-cols-12 gap-4 h-[500px]">
            ...
            >
              <img
                src="/placeholder.svg?height=600&width=800&text=South+Indian+Thali"
            ...
            >
              <img
                src="/placeholder.svg?height=300&width=300&text=Dosa"
                alt="Crispy dosa"
                className="w-full h-full object-cover"
              />
            </div>
            ...
            >
              <img
                src="/placeholder.svg?height=300&width=300&text=Idli"
