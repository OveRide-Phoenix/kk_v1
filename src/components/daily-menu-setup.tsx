...
export function DailyMenuSetup() {
    ...
    const [items, setItems] = useState<
        { name: string; qty: number; rate: number; sort: number; date?: Date }[]
    >([]);
                            ...
                            <TableBody>
                                {items.map((item, index) => (
                                    <TableRow key={index}>
                                        ...
                                        {/* Available Qty (Non-editable placeholder for now) */}
                                ...
                                <TabsContent value="all">
                                    <ScrollArea className="h-[400px] pr-4">
                                        <div className="space-y-4">
                                            {filteredItems(availableItems).map(
                                                (item) => (
                                                    <ItemCard
                                                        key={item.id}
                                                        item={item}
