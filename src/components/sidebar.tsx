...
const developerNavigationItems = [
  {
    name: "Auto Menu Builder",
    icon: Sparkles,
    href: "/admin/developer/auto-menu",
    id: "dev-auto-menu",
  },
...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  if (!mounted) {
    return (
      <aside
        className={`fixed inset-y-0 left-0 z-50 ${collapsed ? "w-20" : "w-64"} bg-card border-r border-border transform transition-transform duration-200 ease-in-out md:relative`}
      >
  ...
  return (
    <aside
      className={`fixed inset-y-0 left-0 z-50 ${collapsed ? "w-20" : "w-64"} bg-card border-r border-border transform transition-all duration-200 ease-in-out 
